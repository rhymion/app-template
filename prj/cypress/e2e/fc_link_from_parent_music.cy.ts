...
/** Navigate to the music EDIT page for 'Test Title 1' and wait for the FcLinkBridgeGrid fetch. */
function goToMusicEdit() {
  cy.intercept('POST', /\/music\/edit\//).as('bridgeFetch');
  cy.visit('/en/music');
...
/** Navigate to the music VIEW page for 'Test Title 1' and wait for the FcLinkBridgeGrid fetch. */
